...
var _navigationButton = require("./navigation-menu/navigation-button");
var _heroSwiperSlider = require("./swiper-slider/hero-swiper-slider");
var _reproduceVideo = require("./modules/reproduce-video/reproduce-video");
var _toursSwiperSlider = require("./swiper-slider/tours-swiper-slider");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _iosVhFix.iosVhFix)();
  window.addEventListener('load', function () {
    (0, _navigationButton.toggleNavigationMenu)();
    (0, _reproduceVideo.reproduceYoutubeVideo)();
    (0, _heroSwiperSlider.initSwiperHero)();
    (0, _toursSwiperSlider.initSwiperTours)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/reproduce-video/reproduce-video":11,"./navigation-menu/navigation-button":12,"./swiper-slider/hero-swiper-slider":13,"./swiper-slider/tours-swiper-slider":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('.description__video');
var cover = document.querySelector('.description__video').querySelector('picture');
var button = document.querySelector('.description__video').querySelector('.description__button-player');
...
exports.toggleNavigationMenu = void 0;
require("../utils/scroll-lock");
require("../utils/focus-lock");
var toggleNavigationMenu = exports.toggleNavigationMenu = function toggleNavigationMenu() {
  var body = document.body;
  var mainNavigation = document.querySelector('[data-menu="main-navigation"]');
  var navigationButton = document.querySelectorAll('[data-menu="menu-button"]');
  var navigationLogotype = document.querySelector('[data-menu="navigation-logo"]');
  var navigationMenuList = document.querySelectorAll('[data-menu="navigation-menu"]');
  var navigationPhone = document.querySelector('[data-menu="navigation-phone"]');
  navigationButton.forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      navigationMenuList.forEach(function (navigationList) {
        var menuClosed = navigationList.classList.contains('navigation__list--is-closed');
        var closedButtonMenu = document.querySelector('[data-menu="is-closed"]');
        var openedButtonMenu = document.querySelector('[data-menu="is-opened"]');
        if (menuClosed) {
...
exports.initSwiperHero = void 0;
var sliderHero = document.querySelector('[data-hero-slider="hero-slider"]');
var swiperHeroPagination = document.querySelector('[data-hero-pagination="hero-swiper-pagination"]');
...
var initSwiperHero = exports.initSwiperHero = function initSwiperHero() {
...
exports.initSwiperTours = void 0;
var swiperButtonNext = document.querySelector('[data-tours-swiper="tours-swiper-next"]');
var swiperButtonPrev = document.querySelector('[data-tours-swiper="tours-swiper-prev"]');
var sliderTours = document.querySelector('[data-tours-slider="tours-slider"]');
var swiperTours = function swiperTours() {
...
var initSwiperTours = exports.initSwiperTours = function initSwiperTours() {
